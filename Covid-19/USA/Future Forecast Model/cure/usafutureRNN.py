...
regressor.fit(X_train, y_train, epochs = 80 , batch_size = 40)
...
plt.plot(df_54, color = 'blue', label = 'Real Covid19 Cure Case')
plt.plot(copy, color = 'red', label = 'Predicted Covid19 Cure Case', alpha = 0.4)
plt.title('USA Covid19 Daywise Cure Prediction')
