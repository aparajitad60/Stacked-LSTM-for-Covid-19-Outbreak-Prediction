...
plt.title('Russia Covid19 Daywise Death Prediction')
plt.xlabel('Days')
plt.ylabel('Cases')
plt.legend()
plt.show()
...
df = pd.read_csv('russia-daily.csv', usecols = ['Deaths'])
df2 = pd.read_csv('russia-daily.csv', usecols = ['Date'])
...
df_old = pd.read_csv('russia1.csv', usecols = ['Date', 'Deaths'])
