...
plt.title('Czech Republic Covid19 Daywise Confirm Prediction')
...
df = pd.read_csv('cr-daily.csv', usecols = ['Confirmed'])
...
df_old = pd.read_csv('cr1.csv', usecols = ['Date', 'Confirmed'])
