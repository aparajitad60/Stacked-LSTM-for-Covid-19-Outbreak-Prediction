...
dataset_train = pd.read_csv('cr1.csv')
...
dataset_test = pd.read_csv('cr2.csv')
...
plt.plot(x_values, y_values, color = 'red', label = 'Real Covid19 Death Case')
plt.plot(x_values, predicted_confirmed_rate, color = 'blue', label = 'Predicted Covid19 Death Case')
plt.title('Czech Republic Covid19 Daywise Death Prediction')
...
df = pd.read_csv('cr-daily.csv', usecols = ['Deaths'])
df2 = pd.read_csv('cr-daily.csv', usecols = ['Date'])
...
df_old = pd.read_csv('cr1.csv', usecols = ['Date', 'Deaths'])
df_pred = pd.read_csv('cr2.csv', usecols = ['Date'])
...
df_54 = copy[:123].copy(deep = True)
df_54.plot()

#visualization of future forecast/prediction
plt.plot(df_54, color = 'blue', label = 'Real Covid19 Deaths Case')
plt.plot(copy, color = 'red', label = 'Predicted Covid19 Deaths Case', alpha = 0.4)
plt.title('Czech Republic Covid19 Daywise Deaths Prediction')
plt.xticks(rotation=60)
plt.tight_layout()
plt.xlabel('Days')
plt.ylabel('Cases')
